...
describe("CosmosParser", () => {
  it("should parse events transfer_to_ton from Tx[]", async () => {
    ...
    const cosmosParser = new CosmwasmBridgeParser(
      "orai1xv4vq2gjthk3j8d3q4sud5vzv2z3d8j2u3g8f0"
    );
    ...
    const expectedEvent: Event = {
      ...
      attributes: [
        ...
        },
        {
          key: "data",
          value:
            "80002255D73E3A5C1A9589F0AECE31E97B54B261AC3D7D16D4F1068FDF9D4B4E18300211F355730DC692D5CF82A6AF76CBC41E5E7B29613B70581035C0D53561F70ED417D78400139517D2",
        },
      ],
    };
    const rawLog = JSON.parse(dataTxs.txs[0].rawLog);
